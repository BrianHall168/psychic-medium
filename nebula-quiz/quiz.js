(() => {
  "use strict";
  const config = {"palette":{"ink":"#241947","muted":"#64577f","surface":"#f8f6ff","accent":"#7553b8","accent_text":"#ffffff"},"eyebrow":"Make space for the message","title":"Prepare for a meaningful reading","intro":"Two gentle choices help set your intention.","result_title":"Your intention is set","result":"Continue when you feel ready to receive guidance.","questions":[{"text":"What kind of connection do you seek?","choices":["Spiritual guidance","A loved one's memory","Life direction"]},{"text":"What would feel most helpful?","choices":["A sign","Understanding","Peace of mind"]}]};
